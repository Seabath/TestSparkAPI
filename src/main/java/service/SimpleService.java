...
public class SimpleService<T extends Serializable> {
    ...
    /**
     * Opens a session from the dao and executes series of queries from the session.
     *
    ...
    /**
     * Opens a session with transaction from the dao and executes series of queries from the
     * session.
     *
     * @param function Function containing queries to execute.
     * @param <V>      Type of return of given function.
